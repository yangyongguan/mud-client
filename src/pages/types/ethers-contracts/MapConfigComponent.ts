...
export type MapConfigStruct = {
  width: PromiseOrValue<BigNumberish>;
  height: PromiseOrValue<BigNumberish>;
  terrain: PromiseOrValue<BytesLike>;
};

export type MapConfigStructOutput = [number, number, string] & {
  width: number;
  height: number;
  terrain: string;
};

export interface MapConfigComponentInterface extends utils.Interface {
  functions: {
    ...
    "set((uint32,uint32,bytes))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "set((uint32,uint32,bytes))",
    values: [MapConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface MapConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MapConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(overrides?: CallOverrides): Promise<[MapConfigStructOutput]>;
