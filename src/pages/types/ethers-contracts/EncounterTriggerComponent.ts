...
export interface EncounterTriggerComponentInterface extends utils.Interface {
  functions: {
...
export interface EncounterTriggerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EncounterTriggerComponentInterface;
